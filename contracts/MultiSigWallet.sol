...
contract MultiSigWallet{
    ...
    function endContributionPeriod() external onlySigner{
        ...
        endContributionBalance = address(this).balance;
    ...
    function submitProposal(uint _valueInWei) external noSigner contributionStateEnd freshProposalOnly checkValue(_valueInWei){
        require(address(this).balance - tempContractBal >= _valueInWei);
    ...
    function listOpenBeneficiariesProposals() external contributionStateEnd view returns (address[]){
        // address[] opBen;
